...
import featuredManifest from '../data/featured_publications.json';
...
const Home = () => {
  ...
  // Featured publication ids come from data/featured_publications.json,
  // which is regenerated by `npm run featured:pick`.
  const FEATURED_IDS = featuredManifest.ids || [];
